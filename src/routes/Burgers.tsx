...
function Burgers() {
  return (
    <>
      ...
      <h1 className="mb-2 text-center text-2xl font-bold text-cyan-800">Step 2: Choose Your Patty</h1>
      ...
      <h1 className="mb-2 text-center text-2xl font-bold text-cyan-800">Step 3: Choose Your Side</h1>
